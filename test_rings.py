...
# [17, 316] and [329, 339]; the open ground is exactly [317, 328].
...
PAL_MID_WITNESSES_BLOB = (
    ...
    "m5gmmZiiRFB4bYQVLmAxbw/8AsRlekWRVlm21x1xfimUH8mQyDWtUfK6+246b8u8h3BN"
    "BOg8X6NEsCm6zavqb2WcDQDuBMltWe5hmSF7gC9ej7/4qEGUGv0W5+fKPW72N9LOoqSW"
    "XqR5w9E9InIRW6R9w00IQxLycCX1MdQ5TBa3fPxzicFK41IuVimrRNAs1VWtxxjqErak"
    "30lo8ip/4ng6ORry0JRLinj3cdim5RGG15Ucj0m3qw/6n6jDrf9Vqs4EXJ91fYZbO+d5"
    "GRTpIN1THWVUx1cnh5tFOzgG+wpXE6d4RZPL5Z+GuJqs00ZeLIdf2X/NrnEk"
)
PAL_4732 = (
...
def test_palindromic_touch_exists_every_mid_length_grandsire_triples():
    ...
    # per lead count L in [74, 316] plus 329-336, verify each
    ...
    # [329, 339]. Unknown: exactly [317, 328].
    ...
    for line in lines.splitlines():
        ls, half = line.split(":")
        wit[int(ls)] = half
    assert sorted(wit) == list(range(74, 317)) + list(range(329, 337))
    m = rings.find_method("Grandsire Triples")
