...
# 329-336, by family-B-only sweeps (/tmp/pal335.py: 15
...
# hits in the very first configs, 2026-07-27; /tmp/pal331.py: FOUR
# cross pairs via meet-in-the-middle over pair-of-pair XORs, capped
# at 400 configs, hits everywhere, 2026-07-27; /tmp/pal330.py: even
# L, 6 heads + FOUR MITM cross pairs, capped at 400 configs, hits
# in the very first config, 2026-07-28; /tmp/pal329.py: FIVE cross
# pairs, MITM join of pair-of-pair with triple-of-pair XORs, capped
...
# cfg327_0 alone has 83 settings, 2026-07-30; /tmp/pal326.py: even
# L, 6 heads + SIX cross pairs, MITM triples x triples join, capped
# at 400 configs, 324 of 400 nonzero, 2026-07-31; /tmp/pal325.py:
# odd L, 7 heads + SEVEN cross pairs, MITM triples x (triples + one
# single) join, capped at 400 configs, 296 of 400 nonzero,
# 2026-07-31; /tmp/pal324.py: even L, SEVEN cross pairs, MITM
# triples x (triples + one single) join, 293 of 400 nonzero;
# /tmp/pal323.py: odd L, EIGHT cross pairs, MITM quads x quads via
# 68C4 bitmask dictB, 230 of 400 nonzero; /tmp/pal322.py: even L,
# EIGHT pairs, same quads x quads join, 264 of 400 nonzero;
# /tmp/pal321.py: odd L, NINE pairs, MITM quints x quads with
# nested incremental-XOR loops, 192 of 400 nonzero; /tmp/pal320.py:
# even L, NINE pairs, same quints x quads join, 217 of 400 nonzero,
# all 2026-08-01; palmitm.py, the committed reconstruction of the
# MITM machinery after a reboot wiped /tmp: L = 319 odd, TEN pairs
# = one folded pair + the quints x quads nonet join, FOUND on its
# first config; L = 318 even, TEN pairs, FOUND on its third; and
# L = 317 odd, ELEVEN pairs = two folded pairs + the nonet join,
# FOUND on its second config, all 2026-08-10). Together with
# PAL_SPECTRUM (exact, nonzero for L = 17..73) and the 337/338/339
# witnesses above, palindromic bobs-only touches of Grandsire
# Triples exist for EVERY lead count L in [17, 339]. With the
# ceiling theorem (nothing at 340+) the existence question is
# completely CLOSED: the attainable lead counts are exactly the
# nonzero PAL_SPECTRUM entries below 17 plus all of [17, 339].
...
PAL_MID_WITNESSES_BLOB = (
    "eNqNXV264rgOfD+rIQkQouVoBdr/0xhIiOon/c3D7Xv6DNiOY0ulUkm93iOrsnL8+f7/"
    "ev/0/Tn3/33+8rc+Ir//bf/l8XNm++j48299xu9rn8+0b3zn2f/+t677J2mIc/j9F2P6"
    "V7QhjsXm+Ys8Jvxbt3P+wgeDAd7Dvm6R9fvwOew+7fG372en+K3xN0bbpN/Inw/Pcc7Y"
    "9imP6X578f7wEtn2WjesLWd8+h79sc631Z/jWPzf6xHVX1PRu2mL/gz+jPYs2Z+17fMx"
    "0t9rjWPMPMduu/Lb633tryh+0nZI6tyfz09/r/4u23L6Rp5PMRa03aKfit/H8lzm+Yv3"
    "irbxVrPNnm2Hiuf6PMM2RzuDsPvnHsMubUv0zWvrba+l7/WY5B76jtvL7Q+3v7rtEfiy"
    "W2bbD5n9htz4LJeF8P/IjVbdO0bn8o5+Y9L5GdK8wdWAlySdrnYktYbXZzrN3+zQ39e+"
    "xqVe0rEs4mhKGgyntG8QNCUBL6nTJZgfC+1kl1ZIXTI2WuFhcoUS016HFZn+DByZ82Xe"
    "QjJHRM/47IumdU0Ljbzq5aL5Y0Nn9dv7tyy3sHme8qfF/lswFx81/JBy2cVqm3KtSj8r"
    "7TmR1ELKdAjEtAS7YArTdmSV9B/Jcrkvyr7UOYwmqzybecmoXJw4ZtTT/yNPiiVN5eZY"
    "6hK2QY8TxOaVGsJl3eRoSNtIJ3HwweAeaSz3MFlaUWwY8ZxGlP+SaOY1UE1Deplqv7HW"
    "R7i9c3E0Uxy6SNd4q0wN0dXJ4WExqhmLfYarcFf2oazPN42erh7WVTpcbIff2f8AX+qm"
    "PA=="
)
PAL_4732 = (
...
# A palindromic 337 (4718 changes), one of EXACTLY 1199 found by the
# full census sweep of all 6923 L=337 complements (2026-07-24). All
# 1199 live in the three family-B complements (7 usable heads + one
# cross pair); every one of the 6920 family-A complements is empty.
# At L=335 the family-B-only sweep (15 complements, two cross pairs,
...
# 2026-07-31) AT LEAST 26865; at L=324 (CAPPED at 400, 293 nonzero,
# 2026-08-01) AT LEAST 20019; at L=323 (CAPPED at 400, 230 nonzero,
# 2026-08-01) AT LEAST 12941; at L=322 (CAPPED at 400, 264 nonzero,
# 2026-08-01) AT LEAST 14452; at L=321 (CAPPED at 400, 192 nonzero,
...
PAL_4718 = (
    ...
    "bpbppppbpbbppbbpbppppbpbbpppbbppppbbppbpbppppbbpppbbppppbpbp"
    "pbbppppbbpppbbpbppppbpbbppbbpbppppbpbbppppbppbpbppbbpppbbppp"
    "pbpbpbppbbpbpppbpppbbpbbppppbbppbbppbpbppbbpppbbpbbppppbbppp"
    "bbpbppppbppbpbpbbppppbpbbppbpbbpppbpb"
)
...
def test_no_palindromic_long_touches_grandsire_triples():
    ...
    # SWEEP VERDICT (2026-07-24, all 6923 configs swept): EXACTLY
    # 1199 single-cycle settings, ALL inside the three family-B
    # complements (202 + 275 + 722); every family-A complement came
    # back empty. All 1199 batch-verified: true, distinct callings.
    # So Grandsire Triples has exactly 1199 palindromic 4718s, and
    # family B has produced EVERY palindromic touch at L = 337, 338
    # and 339 while family A has produced none.
...
def test_palindromic_ceiling_attained_grandsire_triples():
    ...
    # test_no_palindromic_long_touches_grandsire_triples), 338 and
    # 337. All came from family-B complements of their length (all
    # usable alpha-fixed heads removed, minimal extra cross pairs).
    m = rings.find_method("Grandsire Triples")
    t = (1, 2, 5, 7, 3, 6, 4)
    ti = rings.inverse(t)
...
def test_palindromic_touch_exists_every_mid_length_grandsire_triples():
    ...
    # per lead count L in [74, 336], verify each end-to-end. With
    # PAL_SPECTRUM nonzero for 17..73, the 337 sweep census and the
    # 338/339 extremal witnesses, palindromic bobs-only touches
    # exist for EVERY L in [17, 339] — no open ground remains.
    ...
    for line in lines.splitlines():
        ls, half = line.split(":")
        wit[int(ls)] = half
    assert sorted(wit) == list(range(74, 337))
    m = rings.find_method("Grandsire Triples")
