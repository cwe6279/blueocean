...
# count L in [74, 316] plus L = 330, 331, 332, 333, 334, 335 and
# 336, found by
...
# 330-336, by family-B-only sweeps (/tmp/pal335.py: 15
...
PAL_MID_WITNESSES_BLOB = (
    ...
    "m5gmmZiiRFB4bYQVLmAxbw/8AsRlekaRVlm21x1xfimUH8mQyDWtUfK6+246/5blFpZv"
    "scfi4k32i48anKYxZXHWq9yTYe+Rdm4itaAhzcuI7mmOC8Se9mU0oeFIHsP1ycdQ5zC5"
    "0fJRxSWyKY32uASkbH5fcz9XFRRjqEvYQnknTMmrrIRjv+RoyPNNLtXgjfJx45d7GLZU"
    "Micmia2W/X9SCbf+VwkwE8Z81vURbu2cP2OooYN0D2CU0fJenRxuFq3LGOwzXKWZogBN"
    "2ZZ/cOFqsk5xeLEcfmX/AYtVK4Q="
)
PAL_4732 = (
...
def test_palindromic_touch_exists_every_mid_length_grandsire_triples():
    ...
    # per lead count L in [74, 316] plus 330-336, verify each
    ...
    # [330, 339]. Unknown: exactly [317, 329].
    ...
    for line in lines.splitlines():
        ls, half = line.split(":")
        wit[int(ls)] = half
    assert sorted(wit) == list(range(74, 317)) + list(range(330, 337))
    m = rings.find_method("Grandsire Triples")
